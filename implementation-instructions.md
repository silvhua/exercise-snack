...
If you wish to do this step, please ensure you create `src/.env` file containing the additional environmental variables provided through the Synapse submission.
...
1. Create a database named `movement_snack_submission` or whatever `DB_NAME` you choose that is reflected in the `.env` `DB_NAME` variable.
